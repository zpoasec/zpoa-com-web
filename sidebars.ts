      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'modules/fortress/cae',
            'modules/fortress/storefront',
            'modules/fortress/sod-simulation',
            'modules/fortress/entitlements',
            'modules/fortress/vendors',
            'modules/fortress/analytics',
            'modules/fortress/passwordless',
            'modules/fortress/compliance-code',
            'modules/fortress/identity-fabric',
            'modules/fortress/copilot',
          ],
        },
        {
          type: 'category',
