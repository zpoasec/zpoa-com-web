...
|--------|------|-------------|
| GET | `/fortress/passwordless/credentials` | List credentials |
| POST | `/fortress/passwordless/credentials` | Register credential |
| DELETE | `/fortress/passwordless/credentials/:id` | Revoke credential |
| GET | `/fortress/passwordless/policies` | List policies |
| POST | `/fortress/passwordless/policies` | Create policy |
| PUT | `/fortress/passwordless/policies/:id` | Update policy |
| GET | `/fortress/passwordless/adoption` | Adoption statistics |
| GET | `/fortress/passwordless/dashboard` | Dashboard overview |
| GET | `/fortress/passwordless/password-only` | Password-only users |
