...
|--------|------|-------------|
| GET | `/fortress/storefront/items` | Browse catalog items |
| GET | `/fortress/storefront/items/:id` | Get item details |
| POST | `/fortress/storefront/items` | Add catalog item |
| PUT | `/fortress/storefront/items/:id` | Update catalog item |
| POST | `/fortress/storefront/requests` | Submit access request |
| GET | `/fortress/storefront/requests` | List access requests |
| PATCH | `/fortress/storefront/requests/:id/status` | Approve or deny |
| GET | `/fortress/storefront/recommendations/:identityId` | AI recommendations |
| GET | `/fortress/storefront/popular` | Popular items |
| GET | `/fortress/storefront/dashboard` | Dashboard statistics |
