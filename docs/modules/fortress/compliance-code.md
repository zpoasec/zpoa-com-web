...
|--------|------|-------------|
| GET | `/fortress/compliance-code/policies` | List policies |
| POST | `/fortress/compliance-code/policies` | Create policy |
| GET | `/fortress/compliance-code/policies/:id` | Get policy details |
| PUT | `/fortress/compliance-code/policies/:id` | Update policy |
| DELETE | `/fortress/compliance-code/policies/:id` | Delete policy |
| POST | `/fortress/compliance-code/policies/:id/run` | Trigger evaluation |
| GET | `/fortress/compliance-code/runs` | List evaluation runs |
| GET | `/fortress/compliance-code/drifts` | List detected drifts |
| POST | `/fortress/compliance-code/drifts/:id/remediate` | Remediate drift |
| GET | `/fortress/compliance-code/dashboard` | Dashboard statistics |
