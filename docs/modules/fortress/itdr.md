...
|--------|------|-------------|
| GET | `/fortress/itdr/threats` | List identity threats |
| GET | `/fortress/itdr/threats/:id` | Get threat details |
| PATCH | `/fortress/itdr/threats/:id/status` | Update threat status |
| POST | `/fortress/itdr/threats/:id/respond` | Execute response action |
| POST | `/fortress/itdr/responses/:id/rollback` | Rollback a response |
| GET | `/fortress/itdr/rules` | List detection rules |
| POST | `/fortress/itdr/rules` | Create detection rule |
| PUT | `/fortress/itdr/rules/:id` | Update detection rule |
| DELETE | `/fortress/itdr/rules/:id` | Delete detection rule |
| GET | `/fortress/itdr/responses` | List response actions |
| GET | `/fortress/itdr/threats/:id/timeline` | Get threat timeline |
| GET | `/fortress/itdr/dashboard` | Dashboard statistics |
