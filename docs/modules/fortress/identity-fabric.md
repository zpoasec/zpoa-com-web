...
|--------|------|-------------|
| GET | `/fortress/fabric/policies` | List fabric policies |
| POST | `/fortress/fabric/policies` | Create fabric policy |
| PUT | `/fortress/fabric/policies/:id` | Update fabric policy |
| DELETE | `/fortress/fabric/policies/:id` | Delete fabric policy |
| GET | `/fortress/fabric/events` | List correlated events |
| GET | `/fortress/fabric/events/:id` | Get event details |
| GET | `/fortress/fabric/mappings` | List identity mappings |
| POST | `/fortress/fabric/mappings` | Create identity mapping |
| POST | `/fortress/fabric/mappings/:id/resolve` | Resolve mapping conflict |
| GET | `/fortress/fabric/dashboard` | Dashboard statistics |
