...
|--------|------|-------------|
| GET | `/fortress/analytics/risk-scores` | List identity risk scores |
| GET | `/fortress/analytics/risk-scores/:id` | Get specific risk score |
| GET | `/fortress/analytics/departments` | List department risk profiles |
| GET | `/fortress/analytics/departments/:id` | Department detail |
| GET | `/fortress/analytics/trends` | Access trends over time |
| GET | `/fortress/analytics/heatmap` | Risk heatmap data |
| GET | `/fortress/analytics/outliers` | List access outliers |
| GET | `/fortress/analytics/dashboard` | Dashboard statistics |
