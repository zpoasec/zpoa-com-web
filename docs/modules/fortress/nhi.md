...
|--------|------|-------------|
| GET | `/fortress/nhi` | List all NHIs with filtering |
| POST | `/fortress/nhi` | Register a new NHI |
| GET | `/fortress/nhi/:id` | Get NHI details |
| PUT | `/fortress/nhi/:id` | Update NHI metadata |
| DELETE | `/fortress/nhi/:id` | Remove an NHI |
| POST | `/fortress/nhi/:id/rotate` | Trigger credential rotation |
| PATCH | `/fortress/nhi/:id/assign-owner` | Assign or change owner |
| GET | `/fortress/nhi/orphaned` | List orphaned NHIs |
| GET | `/fortress/nhi/overdue-rotations` | List overdue rotations |
| GET | `/fortress/nhi/rotation-policies` | List rotation policies |
| POST | `/fortress/nhi/rotation-policies` | Create rotation policy |
| GET | `/fortress/nhi/dashboard` | Dashboard statistics |
