...
|--------|------|-------------|
| POST | `/fortress/jit/requests` | Create a JIT access request |
| GET | `/fortress/jit/requests` | List JIT requests |
| GET | `/fortress/jit/requests/:id` | Get request details |
| PATCH | `/fortress/jit/requests/:id/status` | Approve or deny request |
| POST | `/fortress/jit/requests/:id/activate` | Activate approved session |
| POST | `/fortress/jit/sessions/:id/extend` | Extend active session |
| POST | `/fortress/jit/sessions/:id/revoke` | Revoke active session |
| GET | `/fortress/jit/sessions` | List active JIT sessions |
| GET | `/fortress/jit/policies` | List JIT policies |
| POST | `/fortress/jit/policies` | Create JIT policy |
| PUT | `/fortress/jit/policies/:id` | Update JIT policy |
| GET | `/fortress/jit/dashboard` | Dashboard statistics |
