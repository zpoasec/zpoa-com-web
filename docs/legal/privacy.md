...
description: How Zpoa Inc. collects, uses, and protects personal data across the Z Shield platform.
---
...
Zpoa Inc. ("Zpoa", "we", "us") operates the Z Shield platform. This policy explains what
personal data we collect, why, and what rights you have.
...
**Account data.** Name, work email, company name, and role, provided at signup.

**Billing data.** Billing contact, address, and subscription tier. Card details are handled
by our payment processor; we do not store full card numbers.

**Support data.** Correspondence you send us, including any information you choose to include.

**Website and product usage data.** Pages visited, referring URL, approximate location
derived from IP, browser and device type, and in-product feature usage. Used to operate,
secure, and improve the Service.

**Marketing data.** If you subscribe to updates, your email and engagement with those messages.
...
personnel as required by local law. The Monitor module includes privacy controls and a
metadata-first default for this reason.
...
We use personal data to provide, secure, and support the Service; to bill and administer
accounts; to communicate about availability, changes, and security; to detect and prevent
fraud and abuse; to improve features; and to comply with law.

**We do not sell personal data.** We do not use Customer Data to train machine learning
...
Account and billing data is retained for the life of the account plus the period required
for tax and legal purposes. Customer Data is retained according to the retention settings
the customer configures, and is available for export for 30 days after termination before
deletion. Website analytics are retained in aggregate.

## 9. Security

We use encryption in transit and at rest, role-based access control, audited administrative
access, secrets management, and regular review. No system is perfectly secure. If a breach
affects your personal data we will notify you and any regulator as required by law.
...
[info@zpoa.com](mailto:info@zpoa.com). For data held in a customer's Z Shield tenant, we
will refer your request to that customer.

You may also lodge a complaint with your supervisory authority.

## 11. Cookies

We use cookies that are strictly necessary for the site to function, plus optional
analytics cookies to understand usage. You can control cookies through your browser
settings. Where required, we will ask for consent before setting non-essential cookies.
...
We may update this policy. Material changes will be notified by email or in-product notice
at least 30 days before taking effect. The "last updated" date above always reflects the
current version.
...
For privacy-specific enquiries, mark your message "Privacy Request".
