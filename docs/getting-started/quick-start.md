...
This guide walks you through creating your Z Shield account and completing the onboarding wizard so you can start monitoring your environment in minutes.
...
The onboarding wizard consists of eight steps. Each step configures a foundational element of your Z Shield deployment. You can revisit and modify any of these settings later from the **Settings** menu.
...
Choose which Z Shield modules to activate. You can enable any combination of Detect, Comply, Discover, Armor, Fortress, and Neural Mesh. Modules can be added or removed at any time.
...
Select from pre-built detection rule packs based on your industry and infrastructure. Z Shield includes hundreds of SIGMA-compatible rules covering common threat scenarios.

### 2.5 -- Compliance Frameworks

Choose the regulatory and industry frameworks relevant to your organization (SOC 2, ISO 27001, PCI-DSS, HIPAA, NIST, GDPR, CIS Benchmarks). Z Shield maps your connected data sources to framework controls automatically.
...
Review your configuration summary and click **Go Live**. Z Shield begins ingesting data, evaluating compliance posture, and running detection rules immediately.
